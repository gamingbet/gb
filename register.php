<style>#element_to_pop_up{display: block; width: 40%; margin-left: 23%; background: #fff; top: 100px !important; left: 0 !important; position: static; max-width: 40%;}</style>
<section class="zaloz-konto" style="display: none;">
